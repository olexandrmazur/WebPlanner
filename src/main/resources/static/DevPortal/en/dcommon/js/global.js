(function () {
    ...
    function addFooterBannerHMStrategy() {
        var strategy1 = false;
        var msg = '<ul><li><div id="teconsent"></div></li><li><a id="adchoices" class="new-window" target="_blank" href="">Ad Choices</a></li></ul>';
    ...
    function checkCustomDocArchDisclaimer(doc) {
        var customDocArchDisclaimer = doc.querySelector("");
        if (customDocArchDisclaimer) {
            ...
            var privacy = customDocArchDisclaimer.parentElement.querySelector("");
            var privacy2 = doc.querySelector("");
            if (privacy || privacy2) {
                if (!privacy && privacy2) {
                    privacy = privacy2;
                }
        ...
        for (var i = 0; i < frames.length; i++) {
            try {
                ...
                if (prodVerDocArchDisclaimer) {
                    ...
                    var AdChoiceMsg = '<a id="adchoices" target="_blank" href="">Ad Choices</a>';
    ...
    function onLoad() {
        ...
        if (consent === null) {
            ...
            if (javaApiDisclaimer) {
                ...
                var AdChoiceMsg = '. Modify <a id="adchoices" target="_blank" href="">Ad Choices</a>.';
